...
ONPRC_FLD=/Users/chris/Dropbox/CURRENT_PROJECTS/NHP_MRI/Template/ONPRC18
...
# warp anatomy ======================================================
IN=${ONPRC_FLD}/Templates/ONPRC18_T2W.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_T1W.nii.gz
...
# warp tensors ======================================================
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_tensors.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_b0.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_rgb.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_fa.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_rd.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_ad.nii.gz
...
IN=${ONPRC_FLD}/Templates/ONPRC18_DTI_tr.nii.gz
...
# warp labelmaps ======================================================
IN=${ONPRC_FLD}/Labelmaps/ONPRC18_GrayMatterLabelmap.nii.gz
...
IN=${ONPRC_FLD}/Labelmaps/ONPRC18_GrayMatterLabelmapCondensed.nii.gz
...
IN=${ONPRC_FLD}/Labelmaps/ONPRC18_GrayMatterWhiteMatterLabelmap.nii.gz
...
cp ${ONPRC_FLD}/Labelmaps/*.txt ${OUT_FLD}/
cp ${ONPRC_FLD}/Labelmaps/*.tsv ${OUT_FLD}/
