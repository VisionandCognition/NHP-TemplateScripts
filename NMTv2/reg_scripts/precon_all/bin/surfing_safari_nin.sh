...
# this is an adapted version of surfing_safari.sh to be used in the NHP-TemplateScripts pipeline of
# the Netherlands Institute for Neuroscience. It assumes an extensive registration to template has
# already been performed based on AFNI's @animal_warper
# Nothing changed yet, but it will happen in this file.
