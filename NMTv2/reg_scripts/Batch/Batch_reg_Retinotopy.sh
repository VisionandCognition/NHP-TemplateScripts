...
source ${ssreg_dir}/define_subjects.sh 'current'
...
do
    ...
    ${ssreg_dir}/ssreg_aff_Retinotopy.sh ${S} ${TEMPLATEFLD} ${NMTVERSION} ${NMTTYPE1} ${NMTTYPE2}
    # perform the nonlinear ROI registration
    ${ssreg_dir}/ssreg_nlin_Retinotopy.sh ${S} ${TEMPLATEFLD} ${NMTVERSION} ${NMTTYPE1} ${NMTTYPE2}
	echo 'DONE'
	echo '========================================='
done