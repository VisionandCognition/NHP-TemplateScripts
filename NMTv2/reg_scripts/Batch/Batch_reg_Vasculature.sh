...
do
	echo '========================================='
	echo Warping Vasculature ${S}
	echo '========================================='
	# perform the affine registration
    ${ssreg_dir}/ssreg_aff_Vasculature.sh ${S} ${TEMPLATEFLD} ${NMTVERSION} ${NMTTYPE1} ${NMTTYPE2}
    # perform the nonlinear registration
    ${ssreg_dir}/ssreg_nlin_Vasculature.sh ${S} ${TEMPLATEFLD} ${NMTVERSION} ${NMTTYPE1} ${NMTTYPE2}
	echo 'DONE'
	echo '========================================='
done